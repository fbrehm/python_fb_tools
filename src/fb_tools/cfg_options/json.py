...
# -*- coding: utf-8 -*-
"""
@summary: The module for the ConfigOptionsJson object.
...
# =============================================================================
class ConfigOptionsJson(BaseConfigOptions):
    """A class for encapsulating all options for generating a json output."""

    _argparse_prefix = "json"
    ...
    def __repr__(self):
        ...
        return super(ConfigOptionsJson, self).__repr__()
