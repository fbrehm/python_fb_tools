...
class TestAppModules(FbToolsTestcase):
    ...
    def test_import_base_app(self):
        ...
        LOG.info("Module version of fb_tools.app is {!r}.".format(fb_tools.app.__version__))
    ...
    def test_import_config_app(self):
        ...
        LOG.info(
            "Module version of fb_tools.cfg_app is {!r}.".format(fb_tools.cfg_app.__version__)
        )
    ...
    def test_import_ddns_app(self):
        ...
        LOG.info("Module version of fb_tools.ddns is {!r}.".format(fb_tools.ddns.__version__))
