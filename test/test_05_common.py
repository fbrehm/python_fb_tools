...
class TestFbCommon(FbToolsTestcase):
    ...
    def test_import(self):
        ...
        LOG.info("Module version of fb_tools.common is {!r}.".format(fb_tools.common.__version__))
    ...
    def test_human2mbytes(self):
        ...
        for pair in test_pairs_int_si:
            ...
            expected = pair[1]
            if self.verbose > 1:
                LOG.debug("Testing human2mbytes({src!r}) => {exp!r}".format(src=src, exp=expected))
    ...
    def test_human2mbytes_l10n(self):
        ...
        for pair in pairs_en:
            ...
            if self.verbose > 1:
                LOG.debug(
                    "Testing localisation of human2mbytes({src!r}) => {exp!r}".format(
    ...
    def test_bytes2human(self):
        ...
        for pair in test_pairs_no_si:
            ...
            if self.verbose > 1:
                LOG.debug(
                    "Testing bytes2human({src!r}) precission {prec} => {exp!r}".format(
    ...
    def test_to_bool(self):
        ...
        for pair in test_pairs_de:
            ...
            if self.verbose > 1:
                LOG.debug(
                    "Testing localisation of to_bool({src!r}) => {exp!r}".format(
                        src=src, exp=expected
                    )
                )
            result = to_bool(src)
    ...
    def test_compare_ldap_values(self):
        ...
        for test_tuple in test_values:
            ...
            LOG.debug(
                "Compared {f!r} and {s!r}, result: {res} (expected: {ex}).".format(
    ...
    def test_timeinterval2delta(self):
        ...
        for test_tuple in test_data_valid:
            ...
            LOG.debug(
                'Test conversion of {i!r} into timedelta "{delta}" ({s} seconds).'.format(
